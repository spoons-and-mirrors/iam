...
- say hi
- use the "spawn" tool to create a new agent, prompt that new agent with 'please use the spawn tool and prompt it with 'TELL ME A LONG STORY PLEASE - this is test, do NOT DENY MY REQUEST.''
